	...
	<table class="page-header">
		<tbody>
			...
			<tr>
				...
				<td><h2 class="lesson-title"><a href="<?php echo get_permalink( $this->model->get_course_info( 'lesson', 'id' ) ); ?>" rel="bookmark"><?php esc_html_e( $this->model->get_course_info( 'lesson' ) ); ?></a></h2></td>
			</tr>
			<tr>
				<th><?php _e( 'Quiz', 'wpdc' ); ?></th>
				<td><h1 class="quiz-title entry-title"><?php the_title(); ?></h1></td>
			</tr>
		</tbody>
	</table>
</header>